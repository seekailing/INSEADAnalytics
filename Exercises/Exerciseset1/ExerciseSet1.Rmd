...
When that is done, executing the summation funcation will lead to a number of 60. This is because myData is a 20*3 matrix while 1st 20 rows of StockReturns is a 20*2 matrix and data in the corresponding coordinates of these matrixs are not identical. Therefore when the operator notequalsto is applied, it return as TRUE (value=1) for all cells. 
