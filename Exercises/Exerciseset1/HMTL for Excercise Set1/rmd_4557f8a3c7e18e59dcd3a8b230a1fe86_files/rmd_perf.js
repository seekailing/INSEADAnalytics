...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 7390 }, { marker: 'pandoc', elapsed: 280 }, { marker: 'post-processor', elapsed: 30 }, { marker: 'pre-processor', elapsed: 20 }, { marker: 'render', elapsed: 8200 } ];
